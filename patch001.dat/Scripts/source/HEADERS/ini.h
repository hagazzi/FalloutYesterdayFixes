...
// Gets the integer value from FalloutYesterday.ini
procedure GetFYConfig(variable key, variable def) begin
   variable val := get_ini_setting("mods\\FalloutYesterday.ini|FalloutYesterday|" + key);
